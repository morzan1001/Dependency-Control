...
_UPDATE_CASES = [*CONFLICT_CASES, *ADD_TO_SET_CASES, *PULL_CASES, *PIPELINE_UPDATE_CASES, *TEAM_OWNERSHIP_CASES, *MEMBER_SOURCE_UPDATE_CASES]
_FIND_CASES = [*ARRAY_MATCH_CASES, *ELEM_MATCH_CASES, *TEAM_DRIFT_CASES, *TEAM_SOURCE_INSTANCE_CASES, *TEAM_MEMBER_SOURCE_CASES]
