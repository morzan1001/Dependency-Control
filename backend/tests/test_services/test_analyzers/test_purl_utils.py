...
class TestParsePurl:
    ...
    def test_parse_returns_none_for_none(self):
        assert parse_purl(None) is None  # type: ignore[arg-type]
...
class TestGetPurlType:
    ...
    def test_returns_none_for_none(self):
        assert get_purl_type(None) is None  # type: ignore[arg-type]
...
class TestNormalizeHashAlgorithm:
    ...
    def test_none(self):
        assert normalize_hash_algorithm(None) == ""  # type: ignore[arg-type]
