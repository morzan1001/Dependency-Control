...
export const scanKeys = {
    ...
    list: (projectId: string, filters: Record<string, any>) => [...scanKeys.project(projectId), 'list', filters] as const,
    ...
    findings: (scanId: string, filters: Record<string, any>) => [...scanKeys.detail(scanId), 'findings', filters] as const,
