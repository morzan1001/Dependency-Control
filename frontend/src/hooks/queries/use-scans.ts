...
export const scanKeys = {
    ...
    list: (projectId: string, filters: Record<string, unknown>) => [...scanKeys.project(projectId), 'list', filters] as const,
    ...
    findings: (scanId: string, filters: Record<string, unknown>) => [...scanKeys.detail(scanId), 'findings', filters] as const,
